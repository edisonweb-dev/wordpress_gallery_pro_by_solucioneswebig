    ...
    ! function(t) {
        var e, n, r = "".concat(["text", "password", "email", "url", "tel", "number", "search", "search-md"].map((function(t) {
            ...
            i = function(t) {
                ...
                e["".concat(n || r ? "add" : "remove", "Class")]("galeriaactive")
            },
            o = function(t) {
        ...
        t(r).each((function(e, n) {
            ...
            i(r), n.validity.badInput && o.addClass("galeriaactive")
        })), t(document).on("focus", r, (function(e) {
            t(e.target).siblings("label, i").addClass("galeriaactive")
        })), t(document).on("blur", r, (function(e) {
            var n = t(e.target),
                r = !n.val(),
                i = !e.target.validity.badInput,
                a = void 0 === n.attr("placeholder");
            r && i && a && n.siblings("label, i").removeClass("galeriaactive"), o(n)
        })), t(document).on("change", r, (function(e) {
            var n = t(e.target);
            i(n), o(n)
        })), t("input[autofocus]").siblings("label, i").addClass("galeriaactive"), t(document).on("reset", (function(e) {
            var n = t(e.target);
            n.is("form") && (n.find(r).removeClass("valid").removeClass("invalid").each((function(e, n) {
                var r = t(n),
                    i = !r.val(),
                    o = !r.attr("placeholder");
                i && o && r.siblings("label, i").removeClass("galeriaactive")
        ...
        u.each((function(t, e) {
            ...
            e.target.type = "text", t("label[for=".concat(e.target.id, "]")).removeClass("galeriaactive")
        }))
    }(jQuery)
}, function(t, e) {
    jQuery((function(t) {
            ...
            e.hasClass("treeview") && function(e) {
                e.find(".rotate").each((function() {
                    ...
                    e.off("click"), e.on("click", (function() {
                        var e = t(this);
                        e.siblings(".nested").toggleClass("galeriaactive"), e.toggleClass("down")
                    }))
                }))
                ...
                e.find(".nested").hide(), r.off("click"), r.on("click", (function() {
                    ...
                    e.toggleClass("open"), r.toggleClass("down"), n.hasClass("galeriaactive") ? n.removeClass("galeriaactive").slideUp() : n.addClass("galeriaactive").slideDown()
                ...
                e.find(".nested").hide(), r.off("click"), r.on("click", (function() {
                    ...
                    e.toggleClass("open"), r.removeClass("fa-plus-circle"), r.addClass("fa-minus-circle"), i.removeClass("fa-minus-circle"), i.addClass("fa-plus-circle"), n.hasClass("galeriaactive") ? n.removeClass("galeriaactive").slideUp() : n.addClass("galeriaactive").slideDown()
                })), n.off("click"), n.on("click", (function() {
                    var e = t(this);
